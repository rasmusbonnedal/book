...
Resultat::Resultat(int unid, Pengar pengar) : _unid(unid), _pengar(pengar) {}

int Resultat::getUnid() const { return _unid; }

Pengar Resultat::getPengar() const { return _pengar; }
